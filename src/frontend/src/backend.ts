...
export class Backend implements backendInterface {
    ...
    async createMeeting(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createMeeting(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async downloadDocument(arg0: string): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
    ...
    async register(arg0: UserProfile): Promise<void> {
        if (this.processError) {
            try {
    ...
    async sendMessageByUsername(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.sendMessageByUsername(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadDocument(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadDocument(arg0, await to_candid_ExternalBlob_n15(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
